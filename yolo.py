...
class YOLO:
    ...
    def draw_bounding_box(self, class_id, confidence, x, y, w, h):
        try:
    ...
    def final_scan(self, indices, boxes, class_id, confidences):
        for i in indices:
            ...
            self.draw_bounding_box(self.img, class_id[i], confidences[i], round(x), round(y), round(x+w), round(y+h))
