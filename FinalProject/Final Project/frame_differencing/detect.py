...
def main():
    ...
    parser.add_argument('-c', '--consecutive-frames', default=4, type=int,dest='consecutive_frames', help='path to the input video')
        ...
        if ret == True:
            ...
            if len(frame_diff_list) == consecutive_frame:
                ...
                for contour in contours:
                    ...
                    total_count += 1
                cv2.putText(orig_frame, f'Total Count {total_count}', (10, 25), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
